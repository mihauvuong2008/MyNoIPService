package ngocdong.group.mynoipservice.config;
...
import ngocdong.group.mynoipservice.dao.UserInfoDAO;
...
@Configuration
@ComponentScan("ngocdong.group.mynoipservice.*")
...
public class ApplicationContextConfig {
	...
	public SessionFactory getSessionFactory(DataSource dataSource) throws Exception {
		...
		try {
			...
			factoryBean.setPackagesToScan(new String[] { "ngocdong.group.mynoipservice.entity" });
